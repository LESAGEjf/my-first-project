...
export declare class IgxCalendarComponent extends IgxMonthPickerBaseDirective implements AfterViewInit, OnDestroy {
     ...
     * @internal
     */
    activeViewDecade(args: Date): void;
    /**
     * @hidden
     * @internal
     */
    activeViewDecadeKB(event: any, args: Date): void;
    /**
     * @hidden
     * @internal
     */
     ...
     * @internal
     */
    activeViewYear(args: Date, event: any): void;
    private focusMonth;
    /**
     * @hidden
     * @internal
     */
    activeViewYearKB(args: Date, event: any): void;
    /**
